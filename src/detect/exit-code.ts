export enum ExitCode {
  ...
  FAILURE_BLACKDUCK_VERSION_NOT_SUPPORTED = 10, //Detect configuration requires a Black Duck capability that is not supported by your version of Black Duck. Ensure that your Black Duck version is compatible with this version of Detect.
...
export function getExitCodeName(exitCode: number): string {
